...
public class ServiceDefinition {
    ...
    public boolean isStaticType() {
        return type == ServiceType.STATIC;
    }
    ...
    public List<AddressDefinition> getAddresses() {
        if (!isStaticType()) {
            throw new IllegalStateException("只有STATIC类型服务才有addresses配置");
        }
        return addresses;
    }
     ...
     * 验证STATIC类型服务配置
     */
    private void validateStaticTypeService() {
     ...
     * 创建STATIC类型服务的构建器
     */
    public static ServiceDefinition.ServiceDefinitionBuilder staticService(String serviceId, String serviceName) {
