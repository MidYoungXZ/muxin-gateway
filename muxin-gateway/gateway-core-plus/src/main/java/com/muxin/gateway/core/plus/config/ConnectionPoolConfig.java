...
public class ConnectionPoolConfig {
    ...
    public void validate() {
        if (maxConnectionsPerTarget <= 0) {
            throw new IllegalArgumentException("maxConnectionsPerTarget必须大于0");
        }
        if (minConnectionsPerTarget < 0) {
            throw new IllegalArgumentException("minConnectionsPerTarget不能小于0");
        }
        if (minConnectionsPerTarget > maxConnectionsPerTarget) {
            throw new IllegalArgumentException("minConnectionsPerTarget不能大于maxConnectionsPerTarget");
        }
        ...
        if (acquireTimeout == null || acquireTimeout.isNegative()) {
            throw new IllegalArgumentException("acquireTimeout必须大于0");
        }
    }
} 