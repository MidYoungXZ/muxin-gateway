...
public interface ConnectionFactory {
     ...
     */
    CompletableFuture<Boolean> validateConnection(BaseConnection connection);
     ...
     * @return 连接健康状态
     */
    ConnectionHealthStatus getConnectionHealth(BaseConnection connection);
    ...
    interface ConnectionFactoryConfig {
         ...
         * 其他协议特定配置
         */
        Map<String, Object> getProtocolSpecificConfig();
    }
    ...
    interface ConnectionFactoryStats {
         ...
         * 创建的服务器连接总数
         */
        long getServerConnectionsCreated();
        
        /**
         * 创建的客户端连接总数
         */
        long getClientConnectionsCreated();
         ...
         * 连接创建失败次数
         */
        long getConnectionCreationFailures();
         ...
         * 连接验证成功次数
         */
        long getConnectionValidationSuccesses();
        
        /**
         * 连接验证失败次数
         */
        long getConnectionValidationFailures();
        ...
        default double getConnectionCreationSuccessRate() {
            long total = getServerConnectionsCreated() + getClientConnectionsCreated();
            long failures = getConnectionCreationFailures();
